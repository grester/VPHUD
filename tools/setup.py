...
def main():
    ...
    print("""
  ######################################
  # VPHUD Development Environment Setup #
  ######################################

  This script will create your VPHUD dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your VPHUD project folder:
    [Arma 3 installation directory]\\{} => VPHUD project folder
    P:\\{}                              => VPHUD project folder
